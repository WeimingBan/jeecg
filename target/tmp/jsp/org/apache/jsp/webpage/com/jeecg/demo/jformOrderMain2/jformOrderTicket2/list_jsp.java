package org.apache.jsp.webpage.com.jeecg.demo.jformOrderMain2.jformOrderTicket2;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_t_datagrid_title_queryMode_pagination_onDblClick_name_idField_fitColumns_fit_filterBtn_checkbox_actionUrl;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_t_datagrid_title_queryMode_pagination_onDblClick_name_idField_fitColumns_fit_filterBtn_checkbox_actionUrl = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_t_datagrid_title_queryMode_pagination_onDblClick_name_idField_fitColumns_fit_filterBtn_checkbox_actionUrl.release();
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write("\n");
      out.write("  </div>\n");
      out.write("   <input type=\"hidden\" id = \"jformOrderTicket2ListMainId\"/>\n");
      out.write(" </div>\n");
      ...
      out.write("\t\t  name:\"jformOrderTicket2\",\n");
      out.write("\t\t  describe:\"订单机票\"\n");
      out.write("\t  });\n");
      ...
      out.write(" \t$(\"#jformOrderTicket2List\").datagrid('beginEdit', index);\n");
      out.write(" }\n");
      out.write("//导入\n");
      out.write("function ImportXls() {\n");
      out.write("\topenuploadwin('Excel导入', 'jformOrderTicket2Controller.do?upload', \"jformOrderTicket2List\");\n");
      out.write("}\n");
      out.write("\n");
      out.write("//导出\n");
      out.write("function ExportXls() {\n");
      out.write("\tJeecgExcelExport(\"jformOrderTicket2Controller.do?exportXls\",\"jformOrderTicket2List\");\n");
      out.write("}\n");
      out.write("\n");
      out.write("//模板下载\n");
      out.write("function ExportXlsByT() {\n");
      out.write("\tJeecgExcelExport(\"jformOrderTicket2Controller.do?exportXlsByT\",\"jformOrderTicket2List\");\n");
      out.write("}\n");
      out.write("\n");
      out.write(" </script>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_t_datagrid_0(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  t:datagrid
    org.jeecgframework.tag.core.easyui.DataGridTag _jspx_th_t_datagrid_0 = (org.jeecgframework.tag.core.easyui.DataGridTag) _jspx_tagPool_t_datagrid_title_queryMode_pagination_onDblClick_name_idField_fitColumns_fit_filterBtn_checkbox_actionUrl.get(org.jeecgframework.tag.core.easyui.DataGridTag.class);
    _jspx_th_t_datagrid_0.setPageContext(_jspx_page_context);
    _jspx_th_t_datagrid_0.setParent(null);
    _jspx_th_t_datagrid_0.setName("jformOrderTicket2List");
    ...
    _jspx_th_t_datagrid_0.setActionUrl("jformOrderTicket2Controller.do?datagrid");
    ...
    if (_jspx_th_t_datagrid_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_t_datagrid_title_queryMode_pagination_onDblClick_name_idField_fitColumns_fit_filterBtn_checkbox_actionUrl.reuse(_jspx_th_t_datagrid_0);
      return true;
    }
    _jspx_tagPool_t_datagrid_title_queryMode_pagination_onDblClick_name_idField_fitColumns_fit_filterBtn_checkbox_actionUrl.reuse(_jspx_th_t_datagrid_0);
    return false;
  ...
  private boolean _jspx_meth_t_dgCol_1(javax.servlet.jsp.tagext.JspTag _jspx_th_t_datagrid_0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  t:dgCol
    org.jeecgframework.tag.core.easyui.DataGridColumnTag _jspx_th_t_dgCol_1 = (org.jeecgframework.tag.core.easyui.DataGridColumnTag) _jspx_tagPool_t_dgCol_width_title_queryMode_field_extendParams_nobody.get(org.jeecgframework.tag.core.easyui.DataGridColumnTag.class);
    ...
    _jspx_th_t_dgCol_1.setTitle("航班号");
    _jspx_th_t_dgCol_1.setField("ticketCode");
    ...
    if (_jspx_th_t_dgCol_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_t_dgCol_width_title_queryMode_field_extendParams_nobody.reuse(_jspx_th_t_dgCol_1);
      return true;
    }
    _jspx_tagPool_t_dgCol_width_title_queryMode_field_extendParams_nobody.reuse(_jspx_th_t_dgCol_1);
    return false;
  ...
  private boolean _jspx_meth_t_dgCol_2(javax.servlet.jsp.tagext.JspTag _jspx_th_t_datagrid_0, PageContext _jspx_page_context)
    ...
    _jspx_th_t_dgCol_2.setTitle("航班时间");
    _jspx_th_t_dgCol_2.setField("tickectDate");
    _jspx_th_t_dgCol_2.setFormatter("yyyy-MM-dd hh:mm:ss");
    _jspx_th_t_dgCol_2.setFilterType("datebox");
    _jspx_th_t_dgCol_2.setExtendParams("editor:{type:'datetimebox',options:{onShowPanel:initDateboxformat}}");
  ...
  private boolean _jspx_meth_t_dgCol_3(javax.servlet.jsp.tagext.JspTag _jspx_th_t_datagrid_0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  t:dgCol
    org.jeecgframework.tag.core.easyui.DataGridColumnTag _jspx_th_t_dgCol_3 = (org.jeecgframework.tag.core.easyui.DataGridColumnTag) _jspx_tagPool_t_dgCol_width_title_queryMode_hidden_field_extendParams_nobody.get(org.jeecgframework.tag.core.easyui.DataGridColumnTag.class);
    ...
    _jspx_th_t_dgCol_3.setTitle("外键");
    _jspx_th_t_dgCol_3.setField("fckId");
    _jspx_th_t_dgCol_3.setExtendParams("editor:'text'");
    ...
    if (_jspx_th_t_dgCol_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_t_dgCol_width_title_queryMode_hidden_field_extendParams_nobody.reuse(_jspx_th_t_dgCol_3);
      return true;
    }
    _jspx_tagPool_t_dgCol_width_title_queryMode_hidden_field_extendParams_nobody.reuse(_jspx_th_t_dgCol_3);
    return false;
  ...
  private boolean _jspx_meth_t_dgDelOpt_0(javax.servlet.jsp.tagext.JspTag _jspx_th_t_datagrid_0, PageContext _jspx_page_context)
    ...
    _jspx_th_t_dgDelOpt_0.setUrl("jformOrderTicket2Controller.do?doDel&id={id}");
